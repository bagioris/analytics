...
module.exports = function(app) {
 ...
 app.get('/api/data', function(req, res) {
  ...
  Subjects.find({}, {'_id': 0, 'school_state': 1, 'resource_type': 1, 'membership_level': 1, 'date_posted': 1, 'total_price': 1, 'payment_type': 1, 'age_level': 1}, function(err, subjectDetails) {
